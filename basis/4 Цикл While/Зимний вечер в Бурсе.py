"""Возьмём число. Умножим его на его же первую цифру. Результат
умножим на первую цифру результата. И так далее. Например, начнём с 8:
8→8∗8=64
64→6∗64=384
384→3∗384=1152
1152→1∗1152=1152
...
n = int(input())
multiplier = int(str(n)[0])

while multiplier > 1 and n <= 1000000000:
    n = n * multiplier
    multiplier = int(str(n)[0])
print(n)
